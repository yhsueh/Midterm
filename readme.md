...
- Demo 
    ...
    Initially, the sample image of a vision impaired person will pop up, and it would be classified as non-dog object, return -1. Subsequently, three street views are being tested with SVM, and the results would be printed in the terminal. The program would halt when one of the three views appear, press any key to proceed to the next view.

## Generate Doxygen Documentation

- Doxygen is a powerful tool that automatically creates the documentation from the codes. Doxygen software is also available in Ubuntu's repository. 
- After making Doxygen style comments, run doxygen -g in the project directory. A configuration file is generated by Doxygen.
- Configure the file: Set RECURSIVE to YES, EXTRACT_ALL to YES.
- In terminal, type doxygen without -g this time.
